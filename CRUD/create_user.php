...
if (!empty($_POST)) {
    ...
    if (empty($errors)) {
        ...
        //if age less than 16 then not allow to register
        if ($age < 16) {
            $msg = "You are not allowed to register, because you are under 16 years old";
            $errors = "You are not allowed to register, because you are under 16 years old";
        } else {
            $sql = "INSERT INTO users (username, email, password, date_of_birth,age) VALUES ('$name', '$email', '$password', '$brithDate','$age')";
                           ...
                           foreach($errors as $error){
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="date" id="birthdayDate" name="brithDate" placeholder="Date Of Birth" class="form-control">
                                </div>
                            </div>
